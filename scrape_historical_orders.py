...
By the authority\1:''', formatted)
    ...
    # Detect and format custom titles under sections without look-behind
...
def main():
    print("Starting historical executive orders scraper...")
    ...
    orders = scrape_historical_orders()
    if not orders:
    ...
    print(f"\nFound {len(orders)} total orders. Processing content...")
    ...
    print(f"\nFinished! Processed {len(orders)} orders, {new_orders} new orders saved.")
